...
extern NODE *numeric_arg(NODE *n);
extern NODE *lright(NODE *n);
extern NODE *lleft(NODE *n);
extern NODE *lforward(NODE *n);
extern NODE *lback(NODE *n);
extern NODE *lshowturtle(NODE *n);
extern NODE *lhideturtle(NODE *n);
extern NODE *lshownp(NODE *n);
extern NODE *lsetheading(NODE *n);
extern NODE *lheading(NODE *n);
extern NODE *pos_int_vector_arg(NODE *n);
extern NODE *ltowards(NODE *n);
extern NODE *lpos(NODE *n);
extern NODE *lscrunch(NODE *n);
extern NODE *lhome(NODE *n);
extern NODE *lclearscreen(NODE *n);
extern NODE *lclean(NODE *n);
extern NODE *lsetpos(NODE *n);
extern NODE *lsetxy(NODE *n);
extern NODE *lsetx(NODE *n);
extern NODE *lsety(NODE *n);
extern NODE *lwrap(NODE *n);
extern NODE *lfence(NODE *n);
extern NODE *lwindow(NODE *n);
extern NODE *lfill(NODE *n);
#ifdef HAVE_WX
extern NODE *lfilled(NODE *n);
#endif
extern NODE *llabel(NODE *n);
extern NODE *ltextscreen(NODE *n);
extern NODE *lsplitscreen(NODE *n);
extern NODE *lfullscreen(NODE *n);
extern NODE *lpendownp(NODE *n);
extern NODE *lpenmode(NODE *n);
extern NODE *lpencolor(NODE *n);
extern NODE *lbackground(NODE *n);
extern NODE *lpensize(NODE *n);
extern NODE *lpenpattern(NODE *n);
extern NODE *lpendown(NODE *n);
extern NODE *lpenup(NODE *n);
extern NODE *lpenpaint(NODE *n);
extern NODE *lpenerase(NODE *n);
extern NODE *lpenreverse(NODE *n);
extern NODE *lsetpencolor(NODE *n);
extern NODE *lsetbackground(NODE *n);
extern NODE *lsetpalette(NODE *n);
extern NODE *lpalette(NODE *n);
extern NODE *lsetpensize(NODE *n);
extern NODE *lsetpenpattern(NODE *n);
extern NODE *lsetscrunch(NODE *n);
extern NODE *lmousepos(NODE *n);
extern NODE *lclickpos(NODE *n);
extern NODE *lbuttonp(NODE *n);
extern NODE *lbutton(NODE *n);
extern NODE *ltone(NODE *n);
extern NODE *larc(NODE *n);
extern NODE *lrefresh(NODE *n);
extern NODE *lnorefresh(NODE *n);
extern NODE *lloadpict(NODE *n);
extern NODE *lsavepict(NODE *n);
extern NODE *lepspict(NODE *n);
...
extern NODE *lsetwindowtitle(NODE *n);
extern NODE *lsettextfont(NODE *n);
extern NODE *lsettextsize(NODE *n);
extern NODE *lsettextstyle(NODE *n);
extern NODE *lsetwindowsize(NODE *n);
extern NODE *lsetwindowxy(NODE *n);
extern NODE *lnewconsole(NODE *n);
extern NODE *lgraphtext(NODE *n);
extern NODE *lregulartext(NODE *n);
extern NODE *lcaninverse(NODE *n);
...
#ifdef HAVE_WX
extern NODE *lfont(NODE *n);
extern NODE *lsetlabelheight(NODE *n);
extern NODE *llabelsize(NODE *n);
extern NODE *lsetfont(NODE *n);
extern NODE *lsettextsize(NODE *n);
extern NODE *ltextsize(NODE *n);
extern NODE *set_text_color(NODE *n);
#endif
