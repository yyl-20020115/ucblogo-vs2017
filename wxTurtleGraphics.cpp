...
void set_palette(int color, unsigned int r, unsigned int g, unsigned int b){
	TurtleCanvas::colors[color+SPECIAL_COLORS] =
				wxColour(r/256,g/256,b/256);
}

void get_palette(int color, unsigned int *r, unsigned int *g, unsigned int *b){
...
void doFilled(int fillcolor, int count, struct mypoint *points) {
    if (drawToPrinter)
